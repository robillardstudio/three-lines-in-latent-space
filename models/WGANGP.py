...
class WGANGP():
    ...
    def train(self, r, c, x_train, batch_size, epochs, run_folder, print_every_n_batches = 10
    , n_critic = 5
    , using_generator = False):
        ...
        for epoch in range(self.epoch, self.epoch + epochs):
            ...
            if epoch % print_every_n_batches == 0:
                self.sample_images(run_folder,r,c)
    ...
    def sample_images(self, run_folder,r,c):
